...
2. [How to build custom authentication with Nginx Ingress](https://github.com/sonamsamdupkhangsar/sonamsamdupkhangsar.github.io/custom-nginx-authentication-with-auth-url-annotation/)