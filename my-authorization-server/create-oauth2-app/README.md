...
In this example, I am going to create a OAuth2 app for a Java application.  This server side app will display the user's access-token when authenticated.  This is for demo purposes only.  Click on `Create Client` link.  I have pasted an image of my client ![oidc-private-client](images/client-create.png).
...
I have created a org called `Yak Yak Yak` [organization](https://authzmanager.sonam.cloud/admin/organizations).![yak yak yak](images/yak-org.png)
